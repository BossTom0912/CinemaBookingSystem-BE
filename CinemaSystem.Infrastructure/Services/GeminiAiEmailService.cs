...
public class GeminiAiEmailService : IAiEmailService
{
        ...
        string? targetSeatType = null)
    {
        ...
        var confirmAcceptUrl = $"http://localhost:5173/api/bookings/{bookingId}/confirm-time-change?accept=true&token={token}";
        var confirmRefundUrl = $"http://localhost:5173/api/bookings/{bookingId}/confirm-time-change?accept=false&token={token}";
