...
public interface IReviewService
{
    ...
    Task<ServiceResult<bool>> AdminRejectReviewAsync(string reviewId, string adminUserId, string? reason = null, CancellationToken cancellationToken = default);
    ...
    Task<ServiceResult<List<ReviewResponse>>> GetFlaggedReviewsAsync(CancellationToken cancellationToken = default);
