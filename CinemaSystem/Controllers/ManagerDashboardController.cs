...
public sealed class ManagerDashboardController : ControllerBase
{
    ...
    [ProducesResponseType(
        typeof(ApiResponse<ManagerDashboardOverviewResponse>),
    ...
    public async Task<IActionResult> GetOverview(
        [FromQuery] ManagerDashboardOverviewQueryRequest request,
        CancellationToken cancellationToken)
    {
        ...
        var result = await _managerDashboardService.GetOverviewAsync(
            scope.CinemaId,
            request,
            cancellationToken);
